...
#
# I1_reduce=LK_Reduce_Iterative("../data/basketball1.png",1)
# I2_reduce=LK_Reduce_Iterative("../data/basketball2.png",1)
# FinalReduceImage1=Lucas_Kanade("../data/basketball1.png",I1_reduce,"../data/basketball2.png",I2_reduce,1,"Reduce")
#
...
#
# I1_expand=LK_Expand_Iterative("../data/basketball1.png",1)
# I2_expand=LK_Expand_Iterative("../data/basketball2.png",1)
# FinalExpandImage1=Lucas_Kanade("../data/basketball1.png",I1_expand,"../data/basketball2.png",I2_expand,1,"Expand")
# plt.imshow(I2_expand)
# plt.show()
...
while True:
    ...
    if not ret:
        break
    I1_expand=LK_Expand_Iterative(frame, 1)
    print("213213")
    I2_expand=LK_Expand_Iterative(new_frame, 1)
    img = Lucas_Kanade(frame, I1_expand, new_frame, I2_expand, 1, "Expand")
    frame = new_frame
